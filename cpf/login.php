...
?>
	...
	<label for="user_password_confirm_input">Confirmar password:</label><br>
...
?>
	...
	<p class="blue_p bold_p">Informacion:</p>
	<ul>
	...
	<li>Con solo un click usted puede reservar</li>
	<li>Su asiento se guardara automaticamente</li>
	<li>Máximo de 5 entradas por alumno</li>
...
?>
	...
	<div class="box_div" id="login_div"><div class="box_top_div"><a href="#">Inicio</a> &gt; Olvido su password? </div><div class="box_body_div">
	...
	<p>Contacte al administrador por email indicando que olvidó su password, y se le asignará uno nuevo. El password podrá ser cambiado luego de loguearse.</p>
...
?>
	...
	<div class="box_div" id="login_div"><div class="box_top_div">Ingresar</div><div class="box_body_div">
	...
	<input type="checkbox" id="remember_me_checkbox" checked="checked"> <label for="remember_me_checkbox">Recordarme </label><br><br>		
	<input type="submit" value="Ingresar">

	</p></form>

	<p id="login_message_p"></p>
	<p><a href="#new_user">Nuevo usuario</a> | <a href="#forgot_password">Olvidó su password?</a></p>
